...
function stageLabel(stage?: string) {
  const labels: Record<string, string> = {
    ...
    starting: '启动渲染',
    'loading-project': '读取项目',
    'project-marked-rendering': '准备渲染',
    'audio-skipped': '跳过旁白',
    'audio-generating': '生成旁白',
    'audio-ready': '旁白就绪',
    'building-input': '生成字幕',
    'loading-remotion': '加载渲染器',
    'bundling-remotion': '打包模板',
    'selecting-composition': '选择模板',
    'rendering-remotion': '合成成片',
    'rendering-media': '输出 MP4',
    'saving-results': '保存结果',
    retrying: '失败重试',
    completed: '成片完成',
    failed: '生成失败'
